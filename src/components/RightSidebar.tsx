      ...
      <div className="space-y-4 pb-4">
        ...
        <div className="card-base overflow-hidden">
          <div className={cn("px-4 pb-4", collapsed && "px-2 pb-2")}>
            <div className={cn("flex items-center gap-2", !collapsed && "mb-4", collapsed && "justify-center")}>
              <div className="p-1.5 rounded-lg bg-primary/10">
                <Sparkles className="w-4 h-4 text-primary" />
              </div>
              {!collapsed && <h3 className="section-title text-sm">AI-Powered Matches</h3>}
            </div>
            {!collapsed && (
          ...
          <div className={cn("px-4 pb-4", collapsed && "px-2 pb-2")}>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center">
                <div className="p-1.5 rounded-lg bg-accent/10" title="Available Teammates">
        ...
        <div className="card-base overflow-hidden">
          <div className={cn("px-4 pb-4", collapsed && "px-2 pb-2")}>
            <div className={cn("flex items-center gap-2", !collapsed && "mb-4", collapsed && "justify-center")}>
              <Users className="w-4 h-4 text-accent" />
              {!collapsed && <h3 className="section-title text-sm">Available Teams</h3>}
            </div>
        ...
        <div className="card-base overflow-hidden">
          <div className={cn("px-4 pb-4", collapsed && "px-2 pb-2")}>
            <div className={cn("flex items-center gap-2", !collapsed && "mb-3", collapsed && "justify-center")}>
              <Zap className="w-4 h-4 text-accent" />
              {!collapsed && <h3 className="section-title text-sm">Platform Stats</h3>}
            </div>
            {collapsed ? (
              <div className="text-center">
                <p className="text-lg font-bold text-primary">{availableUsersCount}</p>
                <p className="text-lg font-bold text-accent mt-1">{availableTeamsCount}</p>
              </div>
            ) : (
