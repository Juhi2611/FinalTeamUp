...
const RightSidebar = ({ onViewProfile, onNavigate, collapsed = false, onToggleCollapse }: RightSidebarProps) => {
  ...
  if (collapsed) {
    return (
      <aside className="w-19 flex-shrink-0 transition-all duration-300 max-h-[calc(100vh-6rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent">
  ...
  return (
    <aside className="w-80 flex-shrink-0 transition-all duration-300 max-h-[calc(100vh-6rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent">
      <div className="space-y-4 pb-4">
