...
import { X, Send, Loader2, Tag, Image as ImageIcon } from 'lucide-react';
...
const CreatePostModal = ({ onClose, onSubmit }: CreatePostModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (submitting) return; // ✅ ADD THIS LINE
  setError('');
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        className="modal-content animate-scale-in max-w-lg max-h-[90vh] overflow-y-auto scrollbar-thin"
